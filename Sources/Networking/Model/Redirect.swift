...
public class Redirect: NSObject, Decodable {
    ...
    public init(url: URL, method: Redirect.Method, parameters: [Parameter]?, suppressIFrame: Bool? = nil, displayInPopup: Bool? = nil, containsAccountPlaceholders: Bool? = nil, type: String? = nil) {
        self.url = url
        self.method = method
