...
class Localizer {
    ...
    func localize<Model>(model: inout Model, using translations: [[String: String]]) where Model: Localizable {
    ...
    private func findTranslation(forKey key: String, in localizations: [[String: String]]) -> String? {
